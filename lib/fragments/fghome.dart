...
import 'package:saloon/network/BaseModel.dart';
import 'package:saloon/network/Retro_Api.dart';
import 'package:saloon/network/ServerError.dart';
import 'package:saloon/screens/detailbarber.dart';
...
class _FgHome extends State<FgHome> {
  ...
  Widget build(BuildContext context) {
   ...
   // ScreenUtil.init(BoxConstraints(
    //  maxWidth: MediaQuery.of().size.width,
    //  maxHeight: M

  //  ))
   ScreenUtil.init(
        BoxConstraints(
           maxWidth:300// MediaQuery.of(context).size.width,
           maxHeight:400// MediaQuery.of(context).size.height),
